...
var ready = function () {
    ...
    chatBox = {
        ...
        createChatBox: function (conversation_id,display, minimizeChatBox) {
            ...
            $("#user-chat-window").append('<div id="chatbox_' + conversation_id + '" class="chatbox"></div>');

            $.get("/conversations/" + conversation_id, function (data) {
                $('#chatbox_' + conversation_id).html(data);
                $("p.message-body").each(function(){
            ...
            $("#chatbox_" + conversation_id).on("click",".chatboxtitle",function () {
                chatBox.toggleChatBoxGrowth(conversation_id);
            });
